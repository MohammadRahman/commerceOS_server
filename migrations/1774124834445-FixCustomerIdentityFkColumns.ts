...
export class FixCustomerIdentityFkColumns1774124834445 implements MigrationInterface {
  name = 'FixCustomerIdentityFkColumns1774124834445';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "customer_identities" DROP COLUMN "customerId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "customer_identities" ADD CONSTRAINT "FK_eca1deaa1424f6bc1ae886f4e06" FOREIGN KEY ("channel_id") REFERENCES "channels"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "customer_identities" DROP CONSTRAINT "FK_eca1deaa1424f6bc1ae886f4e06"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "customer_identities" ADD "customerId" uuid`,
    );
    await queryRunner.query(
