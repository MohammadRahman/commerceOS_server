...
export class OnboardingController {
  ...
  async submit(
    ...
    try {
      ...
      // ── 4. Activate selected payment providers ────────────────────────────
      //    PaymentProviderEntity rows are pre-seeded per org at registration.
      //    We do a clean-slate: deactivate all, then activate selected.
